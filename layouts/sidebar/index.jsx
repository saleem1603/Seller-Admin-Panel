    ...
    <div className="">
      ...
      >
        <div className="flex items-center gap-2.5 font-medium py-3 mx-3 ">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'right', textAlign: 'center',}}>
          <img src="/src/images/logo-light.png" alt="Offers" width="135" className="pl-6" />
          <h6 style={{ color: '#f15a29', padding: '3px', border:"0px solid grey", marginLeft: '23px '}}>Seller Central</h6>
           </div>
        ...
        <div className="flex flex-col  h-full">
          <ul className="whitespace-pre px-2.5 text-[0.9rem] py-5 flex flex-col gap-1  font-medium overflow-x-hidden scrollbar-thin scrollbar-track-customDark scrollbar-thumb-customDark   md:h-[68%] h-[70%]">
            ...
            <li>
              <NavLink to={"/shopprofile"} className="link text-base hover:text-gray-100">
            ...
            <li>
              <NavLink to={"/savetemplate"} className="link text-base hover:text-gray-100">
            ...
            <li>
              <NavLink to={"/offer"} className="link text-base hover:text-gray-100">
            ...
            {/* <li>
              <NavLink to={"/offer"} className="link text-base hover:text-gray-100">
                <BiSolidOffer  size={23} className="min-w-max" />
                Offer
              </NavLink>
            </li> */}

            <li>
              <NavLink to={"/publish"} className="link text-base hover:text-gray-100">
            ...
            <li>
              <NavLink to={"/analytics"} className="link text-base hover:text-gray-100">
            ...
            {/* <li>
              ...
              {/* <NavLink to={"/accounts"} className="link text-white text-base hover:text-gray-100">
                <MdOutlineManageAccounts  size={23} className="min-w-max" />
                Accounts
              </NavLink> */}

              <NavLink to={"/help"} className="link text-white text-base hover:text-gray-100">
                <IoMdHelpCircleOutline   size={23} className="min-w-max" />
                Help Center
              </NavLink>

              <NavLink to={"/setting"} className="link text-white text-base hover:text-gray-100">
